...
function isValidLinkedInUrl(url) {
    ...
    try {
        ...
        // Must be linkedin.com or www.linkedin.com (not subdomain.linkedin.com or linkedin.com.evil.com)
...
function isValidISODate(dateStr) {
    ...
    // Verify the date wasn't rolled over (e.g., month 13 -> month 1 next year)
